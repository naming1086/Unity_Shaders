Shader "Custom/RaymarchCloudsVolumeOnCamera"
{
    Properties
    {
        ...
        _MinHeight ("Min Height", Range (-100.0, 5.0)) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 raymarch(float3 cameraPos, float3 viewDir, fixed4 bgcol, float depth)
            {
                ...
                //MARCH(_Steps, map3, cameraPos, viewDir, bgcol, col, depth * 4, ct);
                //MARCH(_Steps, map4, cameraPos, viewDir, bgcol, col, depth * 8, ct);
                //MARCH(_Steps, map5, cameraPos, viewDir, bgcol, col, depth * 16, ct);
